        ...
        <aside className="w-60 bg-white border-r border-gray-100 p-4 flex flex-col gap-1 shrink-0 overflow-y-auto">
          ...
          {SECTIONS.map(s => (
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-bold text-[12px] relative group ${activeSection === s.id
                  ...
                  <div className="flex gap-6 items-start">
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="flex justify-between items-center mt-2">
                        <p className="text-[10px] text-gray-400 font-bold italic leading-relaxed mb-0">Ghi chú: Mô hình 3D giúp người dùng tương tác trực tiếp lên giao diện bánh.</p>
                        <Button
                          type="primary"
                          className="bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg h-8 px-4 shrink-0 shadow-sm border-none text-[10px]"
                          onClick={() => {
                            window.open("http://localhost:5678/form/3cf7e768-b69e-4347-9292-567ce14e32ab", '_blank', 'noopener,noreferrer');
                          }}
                        >
                          TẠO MODEL 3D
                        </Button>
